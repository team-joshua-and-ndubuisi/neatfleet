...
const servicesData = ['Vacuuming', 'Painting', 'Lawn mowing', 'Clogged sink', 'Roof repair'];
...
const ServiceSelection: React.FC<ServiceSelectionProps> = ({ service }) => {
  return (
    <div className='bg-primary text-white p-4 rounded-md flex items-center justify-center text-center'>
      {service}
    </div>
  );
};
