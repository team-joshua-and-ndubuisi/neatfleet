      ...
      <div className='flex w-full h-1/2 border-3 border-black py-10 flex-col  lg:flex-row lg:justify-center  md:flex-row md:justify-center rounded'>
        ...
        <div className='flex mx-30'>
          <div className=' flex flex-col items-center justify-around '>
            <span className='py-5 text-2xl font-semibold'>
              Number of Bookings
              {bookings}
            </span>
            <span className='py-5 text-2xl font-semibold'>
            ...
            {userType === 'tech' && (
              <div className='flex flex-col items-center'>
                <Link
                  ...
                  className='text-md font-semibold py-5 border border-primary-300 rounded px-3 my-2 hover:bg-primary-300 focus:outline-2 focus:outline-offset-2 focus:outline-accent active:bg-slate-300 duration-150'
                >
